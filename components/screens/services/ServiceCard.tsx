  ...
  return (
    <motion.article
      ...
      <div className="p-[clamp(16px,2vw,24px)]">
        <h3 className="font-heading font-bold text-fluid-lg text-[#0A1628] mb-2 leading-tight">
          {title}
        </h3>
        <p className="text-fluid-sm text-[#64748B] mb-4 leading-relaxed">
          {description}
        </p>
        ...
        <ul className="space-y-2">
          ...
          <li
            key={idx}
            className="flex items-center gap-2 text-fluid-sm text-[#0A1628]/80">
